...
Every model you touched validates its own inputs, every knob lives on a settings class, and no line re-implements something in the table above. Every model you proposed converting sits outside its package's contract family, and every one you kept holds data.
